      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <!-- Mi Form -->
             <div class="cardp">
              <div class="cardp-header" style="background: #001F3F; color:white">
                <h3 class="card-title"><b>Personalizado</b></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form">
                ...
                <div class="card-footer">
                  <button type="button" class="btnp btn-salir">Salir</button>
                  <button type="submit" class="btnp btn-personalizado float-right">Guardar</button>
                </div>
              </form>
            </div>
