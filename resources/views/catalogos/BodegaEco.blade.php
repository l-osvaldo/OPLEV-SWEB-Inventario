...
<div class="card">
  <div class="card-body" >
    ...
    <a href="{{ route('bajasDefinitivasEco') }}" style="background-color: #E71096" class="btn btn-secondary" >
                    ...
                    <table id="tableCatalogo" name="tableCatalogo" class="table table-bordered table-striped display" style="width:100%">
                        ...
                        <tbody>
                          @foreach ($articulos as $articulo)
                            <tr data-toggle="tooltip" data-placement="top" title="Click para ver toda la información del artículo: {{ $articulo->concepto }}, Número de inventario: {{ $articulo->numeroinventario }} " onclick="abrirModalEditar('{{ $articulo->numeroinventario }}');">
