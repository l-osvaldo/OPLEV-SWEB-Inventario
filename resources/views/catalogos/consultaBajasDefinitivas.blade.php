                        ...
                        <tbody>
                          @foreach ($articulos as $articulo)
                            <tr data-toggle="tooltip" data-placement="top" title="Click para ver toda la información del artículo: {{ $articulo->concepto }}, Número de inventario: {{ $articulo->numeroinv }} ">
                              <td onclick="abrirModalEditar('{{ $articulo->numeroinv }}');"> {{ $articulo->movimiento }} </td>
                              <td onclick="abrirModalEditar('{{ $articulo->numeroinv }}');"> 2 </td>
                              <td onclick="abrirModalEditar('{{ $articulo->numeroinv }}');"> {{ $articulo->fechaBaja }} </td>
                              <td onclick="abrirModalEditar('{{ $articulo->numeroinv }}');"> $ {{ $articulo->importe }} </td>
                              <td style="text-align: center"> <button class="btn btn-secondary" style="background-color: #E71096; border-color: #E71096"><i class="fa fa-file-pdf-o fa-2x" aria-hidden="true"></i></button></td>
                            </tr>
