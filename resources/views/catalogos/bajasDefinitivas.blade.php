...
<!-- Navbar -->
@include('partials.header',['tituloEncabezado' => 'Bienes en Bodega'])
<!-- /.navbar -->
            ...
            <div class="card-body">
                ...
                <div class="row">
                  <div class="col-md-12" style="text-align: right;">
                        <button type="submit" id="btnEnvArtBajDef" style="background-color: #E71096" class="btn btn-secondary float-right d-none" onclick="enviaArtBajaDefinit();">
